...
with safe_import_context() as import_ctx:
    from skglm import AdaptiveGraphicalLasso
...
class Solver(BaseSolver):
    ...
    name = 'skglm-adaptive-graphical-lasso'
    ...
    def run(self, n_iter):
        """Run the skglm AdaptiveGraphicalLasso algorithm."""
        self.estimator = AdaptiveGraphicalLasso(
            alpha=self.alpha,
            max_iter=n_iter
        )
